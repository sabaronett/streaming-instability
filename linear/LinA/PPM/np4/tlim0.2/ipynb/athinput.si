...
nlim       = -1		# cycle limit
tlim       = 0.2	# time limit (in orbital periods, /yr)
...
x2min  = -0.00523598775598298873	# minimum value of X2
x2max  =  0.00523598775598298873	# maximum value of X2
...
omega = 6.28318530717958648	# local Keplerian angular frequency (2π/yr, r = 1 AU)
# ---YJ07, Table 1---
...
dvpz_im  = -0.0077776652	# Imaginary part of the z-component in particle velocity perturbation
