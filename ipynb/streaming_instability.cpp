...
void Mesh::InitUserMeshData(ParameterInput *pin) {
  ...
  EnrollUserHistoryOutput(6, Drhop, "drhop");
  EnrollUserHistoryOutput(7, Drhop2, "drhop2");
  EnrollUserHistoryOutput(8, Dvpx, "dvpx");
  EnrollUserHistoryOutput(9, Dvpx2, "dvpx2");
  EnrollUserHistoryOutput(10, Dvpy, "dvpy");
  EnrollUserHistoryOutput(11, Dvpy2, "dvpy2");
  EnrollUserHistoryOutput(12, Dvpz, "dvpz");
  EnrollUserHistoryOutput(13, Dvpz2, "dvpz2");
}
