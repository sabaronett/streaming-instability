...
# NOTE: In this version, the dust and gas density fields are subtracted by the
# dust-to-gas mass ratio (epsilon) and unity, respectively.
#
...
axs[0][0].text(-0.65, 1.31,
               r'$\overline{\mathrm{R}_{\rho_\mathrm{p}\rho_\mathrm{p}}^\prime}$',
               ha='left', va='top', transform=axs[0][0].transAxes)
axs[1][0].text(-0.65, 1.31,
               r'$\overline{\mathrm{R}_{\rho_\mathrm{g}\rho_\mathrm{g}}^\prime}$',
