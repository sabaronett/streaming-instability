...
# for case AB.
# NOTE: In this version, the gas density field is subtracted by unity before
...
plt.savefig(f'figs/{case}_Rs_pow-spect_alt-gas.png', dpi=1000, bbox_inches='tight',
            pad_inches=0.01)
